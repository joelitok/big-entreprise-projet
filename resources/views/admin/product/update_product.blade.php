    ...
    <div class="main-panel">
        <div class="content-wrapper">
            <div class="row grid-margin">
                <div class="col-12">
                    <form method="post" action="{{ url('/product_update_save_action_a') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <input class="form-control" type="number" value="{{ $product->stock_min }}"
                                            name="stock_min" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <input class="form-control" type="number" value="{{ $product->poids }}"
                                            name="poids" required>
                                    </div>
                                </div>
