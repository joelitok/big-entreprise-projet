    ...
    <div class="main-panel">
        <div class="content-wrapper">
            <div class="row grid-margin">
                <div class="col-12">
                    <form method="post" action="{{ url('/product_attach_add_save') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h4 class="card-title" style="text-align: center">Nouveau product_attach</h4>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <input class="form-control" name="product_attach_image" type="file" required>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
