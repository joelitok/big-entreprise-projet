...
<body>
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        ...
        <a class=" mr-5" href="{{URL::to('/admin_sale')}}"><img src="{{asset('backend/images/2h_.png')}}" class="mr-2" alt="logo" height="60px" width="75px"/></a>
        @if(Session::has('admin_sale_name'))
             <b>Gestionnaire de vente</b>
        @endif
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
        ...
        <ul class="navbar-nav navbar-nav-right">
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link" href="{{URL::to('/admin_sale')}}" data-toggle="dropdown" id="profileDropdown">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link" href="{{URL::to('/admin_sale')}}">
          ...
          <li class="nav-item">
            ...
            <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="{{URL::to('/list_orders_sale')}}"> Les commandes</a></li>
            </ul>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="table">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{URL::to('/admin_sale_profile')}}">Mes paramètres</a></li>
             </ul>
            </div>
          </li>
  ...
  <script>
    ...
    bootbox.confirm("Envoyer le produit chez un livreur?", function(confirmed){
      if (confirmed){
