                ...
                <div class="col-lg-8 col-md-9">
                    ...
                    <div class="card style-2 mb-4">
                        <div class="card-header">
                            <h4 class="mb-0">
                                @if ($count_orders)
                                    {{ $count_orders }} commande(s) déja effectué dans le système
                                @else
                                        ...
                                        @isset($orders)
                                            ...
                                            @foreach ($orders as $order)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn-sm  btn-outline-primary" data-toggle="modal"
                                                            data-target="#exampleModalLong{{ $order->id }}"><i
                                                                class="ti ti-eye">
                                                            </i> </a>
                                                    </td>
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <p>
                                                                        @if($order->image_facture)
                                                                        <img class="img-responsive" style="margin:0 auto;" 
                                                                        src="/storage/facture_images/image{{ $order->id }}.png"/> 
                                                                        @endif
                                                                    </p>
