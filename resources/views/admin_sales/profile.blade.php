              ...
              <div class="row">
                <div class="col-lg-4">
                  <div class="border-bottom text-center pb-4">
                    ...
                    <div class="mb-3">
                      <h3>
                        @isset($admin_sale_profiles) 
                        {{strtoupper($admin_sale_profiles->lastname)}}
                           {{$admin_sale_profiles->firstname}}
                        @endisset
                      </h3> 
                        </div>
                    ...
                    <div class="d-flex justify-content-center">
                      @isset($admin_sale_profiles)
                      Profiles crée le :
                      {{$admin_sale_profiles->created_at->format('d /m/ Y')}}
                        @endisset
                  ...
                  <div class="py-4">
                    <p class="clearfix">
                      ...
                      <span class="float-right text-muted">
                        @isset($admin_sale_profiles)
                        @if($admin_sale_profiles->status===1)
                        Active
                        @else 
                         Désactiver
                        @endif
